    ...
    async def solve(
        ...
        for sim in range(self.max_simulations):
            ...
            if selected.children:
                rollout_node = random.choice(selected.children) if selected.children else selected
            ...
            self._backpropagate(selected if not selected.children else rollout_node, reward)
